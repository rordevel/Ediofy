class CreateUserContributionsVideos < ActiveRecord::Migration[5.0]
  def up
    ...
    CREATE OR REPLACE FUNCTION user_contributions_video(p_limit INTEGER, p_offset INTEGER, p_user_id INTEGER, p_search VARCHAR DEFAULT NULL, p_sort VARCHAR = 'latest')
      RETURNS TABLE(
        id INTEGER,
        type VARCHAR,
